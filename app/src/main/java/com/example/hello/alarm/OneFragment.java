                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            Integer mFriendPoint = Integer.valueOf(snapshot.child("Point").getValue().toString());
...
//                        String jsonString = response.getRawResponse();
//                        Log.e("Duy", "onCompleted: "+jsonString);
                     /*   try {
...
//        request.executeAsync();
    ...
    public class FriendAdapter extends ArrayAdapter<Friend>{
        ...
        public FriendAdapter(@NonNull Context context, int resource, ArrayList<Friend> friendList) {
        ...
        public  View getView(int position, View convertView, @NonNull ViewGroup parent){
            ...
            if (convertView == null){
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.friend_list_item_layout, parent, false);
            }

            ImageView mFriendImage = convertView.findViewById(R.id.friend_image);
            TextView mFriendName = convertView.findViewById(R.id.friend_name);
            TextView mFriendPoint = convertView.findViewById(R.id.friend_point);

            //Load friend's image
            Glide.with(getContext())
                    .load(friend.mFriendImageUri)
                    .into(mFriendImage);

            //Show friend's name and point
            mFriendName.setText(friend.mFriendName);
            mFriendPoint.setText(String.format("%d POINT", friend.mFriendPoint));
